...
public class FacialAnimsController : MonoBehaviour
{
    ...
    [SerializeField] private float minBlinkInterval = 6f;
    [SerializeField] private float maxBlinkInterval = 14f;

    [SerializeField] private float minStareDuration = 1f;
    [SerializeField] private float maxStareDuration = 3f;
    [SerializeField] private float minStareInterval = 10f;
    [SerializeField] private float maxStareInterval = 27f;
