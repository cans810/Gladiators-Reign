...
public class UIRewardGladiator : MonoBehaviour
{
    ...
    public void SetRewardedGladiator(GameObject gladiator_rewarded){
        ...
        SpriteRenderer foundHeadSprite = gladiator_rewarded.transform.Find("GladiatorModel").transform.Find("head").GetComponent<SpriteRenderer>();

        gladiatorHeadImage.sprite = foundHeadSprite.sprite;
        gladiatorHeadImage.color = foundHeadSprite.color;
