...
public class TrainingController : MonoBehaviour
{
    ...
    public void initTrainingDummy(GameObject dummy, GameObject partnerGL)
    {
        ...
        if (partnerGL.transform.localRotation.y == 180) dummy.transform.localRotation = Quaternion.Euler(0, 0, 0);
        else if (partnerGL.transform.localRotation.y == 0) dummy.transform.localRotation = Quaternion.Euler(0, 0, 0);
