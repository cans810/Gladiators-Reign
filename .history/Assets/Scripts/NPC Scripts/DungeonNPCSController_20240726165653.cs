...
public class DungeonNPCSController : MonoBehaviour
{
    ...
    public void setBlacksmithActive(bool isActive){
        ...
        if (isActive == true){
            ...
            if (GameObject.Find("Inactive NPCs").gameObject != null){
                blackSmith.transform.SetParent(GameObject.Find("Inactive NPCs").gameObject.transform);
    ...
    public void setMultifightArrangerActive(bool isActive){
        ...
        if (isActive == true){
            ...
            if (GameObject.Find("Inactive NPCs").gameObject != null){
                multiFightArranger.transform.SetParent(GameObject.Find("Inactive NPCs").gameObject.transform);
