...
public class NPCBlacksmithController : NPCControllerBase
{
    ...
    {
        if (!string.IsNullOrEmpty(sentence_1) || !string.IsNullOrEmpty(sentence_2) || !string.IsNullOrEmpty(sentence_3) || !string.IsNullOrEmpty(sentence_4))
        {
            int randomSentence = Random.Range(1,5);
            isTalking = true;
            writingEffect.AnimateText(sentence_ + randomSentence);
