...
public class RewardsManager : MonoBehaviour
{
    ...
    public GameObject getRewardItem(){
        return AllItemsContainer.Instance.GetAnyArmor(reward_ItemPrefab.GetComponent<UIRewardItem>().actual_Item.GetComponent<Armor>().itemName);
    }

    public int getRewardCoin(){
        return reward_CoinPrefab.GetComponent<UIReward>().quantity;
    }

    public GameObject getRewardGladiator(){
        // turn enemy to player
        Enemy enemy = reward_GladiatorPrefab.GetComponent<UIRewardGladiator>().gladiator_rewarded.GetComponent<Enemy>();
        Destroy(enemy);

        reward_GladiatorPrefab.GetComponent<UIRewardGladiator>().gladiator_rewarded.AddComponent<Player>();
        reward_GladiatorPrefab.GetComponent<UIRewardGladiator>().gladiator_rewarded.AddComponent<GLCommandsManager>();
        



        return reward_GladiatorPrefab.GetComponent<UIRewardGladiator>().gladiator_rewarded;
    }
