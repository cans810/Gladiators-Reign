...
public class BattleObjectsController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Player.Instance.transform.localScale = new Vector3(Player.Instance.transform.localScale.x,Player.Instance.transform.localScale.y,Player.Instance.transform.localScale.z);
        InitCell();
