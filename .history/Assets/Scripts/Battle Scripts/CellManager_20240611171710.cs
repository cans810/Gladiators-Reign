...
public class CellManager : MonoBehaviour
{
    ...
    public void InitCellView(){
        ...
        // Player.Instance.gameObject.transform.rotation = Quaternion.Euler(transform.rotation.x, 0f, transform.rotation.z);
        // Player.Instance.GetComponent<GLAttributes>().ChangeMaterial(litMaterial);  

        // Player.Instance.transform.localScale = Player.Instance.GetComponent<GLAttributes>().battleSize * 3.2f;
