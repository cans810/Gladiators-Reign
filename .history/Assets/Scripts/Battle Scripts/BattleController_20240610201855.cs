...
public class BattleController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (allEnemiesDead && !battleHasEnded){
            ...
            Player.Instance.gameObject.GetComponent<GLBattleAI>().StopAI();
        ...
        else if (!Player.Instance.GetComponent<GLState>().alive && !battleHasEnded){
            BattleEndCanvas.SetActive(true);
            SetButtons();
            battleHasEnded = true;
            ...
            foreach (GameObject enemy in enemies)
            {
                ...
                {
                    enemy.gameObject.GetComponent<GLBattleAI>().StopAI();
    ...
    public bool areAllEnemiesDead()
    {
        foreach (GameObject enemy in enemies)
        {
            ...
            else if (enemy.GetComponent<GLState>().alive)
            {
                return false;
            }
        }
