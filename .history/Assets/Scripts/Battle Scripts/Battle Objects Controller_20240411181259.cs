...
public class BattleObjectsController : MonoBehaviour
{
    ...
    public void InitCellView(){
        ...
        Cell.GetComponent<CellManager>().SpeakingText.GetComponent<TextMeshProUGUI>().text = "Are you ready gladiator?";
        Cell.GetComponent<CellManager>().SpeakingText.GetComponent<TextWritingEffect>().AnimateText();
    }
    ...
    public void NoButton(){
        Cell.GetComponent<CellManager>().SpeakingText.GetComponent<TextMeshProUGUI>().text = "You have no other choice...";
