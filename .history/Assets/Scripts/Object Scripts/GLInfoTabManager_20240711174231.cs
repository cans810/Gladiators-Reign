...
public class GLInfoTabManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GLClass.GetComponent<TextMeshProUGUI>().text = GLBelongTo.GetComponent<GLAttributes>().GL_Class.ToString();
    }
    ...
    public void seeAttributesHovered(){
        seeAttributesButton.GetComponent<TextMeshProUGUI>().color = Color.black;
    ...
    public void seeAttributesHoverExit(){
        seeAttributesButton.GetComponent<TextMeshProUGUI>().color = buttonColor;
