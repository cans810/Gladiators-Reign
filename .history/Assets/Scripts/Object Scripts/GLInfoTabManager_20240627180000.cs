...
public class GLInfoTabManager : MonoBehaviour
{
    ...
    public void seeAttributesHovered(){
        seeAttributesButton.GetComponent<TextMeshProUGUI>().color =  new Color(seeAttributesButton.GetComponent<TextMeshProUGUI>().color.r + 25,seeAttributesButton.GetComponent<TextMeshProUGUI>().color.g,seeAttributesButton.GetComponent<TextMeshProUGUI>().color.b,seeAttributesButton.GetComponent<TextMeshProUGUI>().color.a);
