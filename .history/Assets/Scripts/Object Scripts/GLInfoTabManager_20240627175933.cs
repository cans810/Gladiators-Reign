...
public class GLInfoTabManager : MonoBehaviour
{
    ...
    public void seeAttributesHovered(){
        seeAttributesButton.GetComponent<TextMeshProUGUI>().color =  new Color(seeAttributesButton.GetComponent<TextMeshProUGUI>().color.r,seeAttributesButton.GetComponent<TextMeshProUGUI>().color.g,seeAttributesButton.GetComponent<TextMeshProUGUI>().color)
