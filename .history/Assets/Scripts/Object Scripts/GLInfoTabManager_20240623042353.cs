...
public class GLInfoTabManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        atrb_Fortitude.text = GLBelongTo.GetComponent<GLAttributes>().F.ToString();
        atrb_Harmony.text = GLBelongTo.GetComponent<GLAttributes>().Vitalis.ToString();
        atrb_ArcaneMastery.text = GLBelongTo.GetComponent<GLAttributes>().Vitalis.ToString();
    }
