...
public class ItemStandManager : MonoBehaviour
{
    ...
    public void showItemInfo(){
        if (!isPopupInstantiated){
            itemContained.GetComponent<SpriteRenderer>().material = 
            ...
            infoPopup.transform.position = new Vector3(gameObject.transform.position.x + 1.6f, gameObject.transform.position.y + 2, gameObject.transform.position.z);
