...
public class CommonActions : MonoBehaviour
{
    ...
    public void DamageMelee(){
        if (glManager.HitBox.objectsInHitbox.Contains(glManager.battleAI.currentEnemyChosen)){
            if (glManager.battleAI.currentEnemyChosen != null && !glManager.battleAI.currentEnemyChosen.GetComponent<BattleAI>().boolActionsDict["TakeGuard"] 
            && (!glManager.battleAI.currentEnemyChosen.GetComponent<GLAttributes>().dying && glManager.battleAI.currentEnemyChosen.GetComponent<GLAttributes>().alive)){
                ...
                glManager.battleAI.currentEnemyChosen.GetComponent <GLAttributes>().amount_GotHit = hpBefore - gladiatorManager.battleAI.currentEnemyChosen.GetComponent<GLAttributes>().HP;
