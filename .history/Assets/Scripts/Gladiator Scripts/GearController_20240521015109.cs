    ...
    void Update()
    {
        ...
        if (legGuardSpot_right != null){
            if (LegGuardWorn == null){
                ...
                legGuardSpot_right.GetComponent<SpriteRenderer>().sprite = WristGuardWorn.texture;
                legGuardSpot_left.GetComponent<SpriteRenderer>().sprite = WristGuardWorn.texture;
            }
        }
    }
}
