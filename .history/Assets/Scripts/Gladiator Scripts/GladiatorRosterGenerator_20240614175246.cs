...
public class GladiatorRosterGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ///ppc.cropFrameX = PixelPerfectCamera.CropFrame.Pillarbox; // Example: Set to Pillarbox
        //ppc.cropFrameY = PixelPerfectCamera.CropFrame.Letterbox; // Example: Set to Letterbox
