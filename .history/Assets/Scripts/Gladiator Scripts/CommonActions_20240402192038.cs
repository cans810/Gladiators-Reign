...
public class CommonActions : MonoBehaviour
{
    ...
    IEnumerator WalkToPointMeleeAttackCoroutine(Vector2 position)
    {
        ...
        while (!hasArrivedToAttack(position))
        {
    ...
    IEnumerator KeepDistanceCoroutine(Transform enemyTransform)
    {
        ...
        CheckBorders(targetPosition)

        attributes.battleAI.targetWalkPos = targetPosition;
    ...
    public void CheckBorders(Vector2 targetPosition){
        ...
        if (borderObject != null)
        {
            ...
            if (targetPosition.y > borderYPosition)
            {
                ...
                targetPosition.y = borderYPosition - 0.1f; // Adjust as necessary
            }
        }
        else
        {
