...
public class CommonActions : MonoBehaviour
{
    ...
    public void AttackMelee(){
        if (glManager.battleAI.currentEnemyChosen != null && glManager.battleAI.currentEnemyChosen.GetComponent<GladiatorManager>().alive){
    ...
    private IEnumerator getKilledCoroutine(string animationName){
        ...
        GetComponent<GLState>().alive = false;
    }
