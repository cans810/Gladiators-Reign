...
{
    public GameObject GladiatorModel;
    ...
    void Start()
    {
        GladiatorModel = transform.Find("GladiatorModel").gameObject;
    ...
    private void UpdateGearSortingLayer(GameObject spot, string bodyPartName)
    {
        if (isSpotFull(spot))
        {
            GameObject bodyPart = GladiatorModel.transform.Find(bodyPartName).gameObject;
            ...
            if (bodyPart != null)
            {
                ...
                {
                    GameObject gearItem = getItemInSpot(spot);
                    UpdateRendererSortingLayer(gearItem, "Default", bodyPartRenderer.sortingOrder + 1);
                }
            }
        }
    }

    private void UpdateRendererSortingLayer(GameObject obj, string sortingLayerName, int sortingOrder)
    {
