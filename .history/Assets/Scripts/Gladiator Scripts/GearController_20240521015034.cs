    ...
    void Update()
    {
        ...
        if (wristGuardSpot_right != null){
            if (ShoulderguardWorn == null){
                ...
                wristGuardSpot_right.GetComponent<SpriteRenderer>().sprite = ShoulderguardWorn.texture;
                wristGuardSpot_left.GetComponent<SpriteRenderer>().sprite = ShoulderguardWorn.texture;
            }
        }
