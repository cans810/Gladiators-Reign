...
public class DetachEntityParts : MonoBehaviour
{
    ...
    public void detachHead()
    {
        ...
        Transform detachedHeadBonePrefabPos = detachedHeadPrefab.transform.Find("headPos");
        ...
        if (foundHead != null && foundHeadBone != null)
        {
            ...
            GameObject detachedHeadBone = GameObject.Instantiate(foundHeadBone.gameObject);

            detachedHeadBone.transform.localPosition = new Vector3(detachedHead.transform.localPosition.x, detachedHead.transform.localPosition.y*20, detachedHead.transform.localPosition.z);
