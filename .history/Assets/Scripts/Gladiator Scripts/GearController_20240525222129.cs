...
public class GearController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!isSpotFull(helmetSpot) && inventory.HelmetWorn)
        {
            GameObject helmet = GameObject.Instantiate(inventory.HelmetWorn);
        ...
        if (!isSpotFull(chestplateSpot) && inventory.ChestplateWorn)
        {
            GameObject chestplate = GameObject.Instantiate(inventory.ChestplateWorn);
        ...
        if (!isSpotFull(shoulderguardSpot_right) && ShoulderguardWorn)
        {
        ...
        if (!isSpotFull(legGuardSpot_right) && LegGuardWorn)
        {
        ...
        if (!isSpotFull(shoesSpot_right) && ShoesWorn)
        {
