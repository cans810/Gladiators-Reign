...
public class CommonActions : MonoBehaviour
{
    ...
    IEnumerator KeepDistanceCoroutine()
    {
        ...
        Vector2 targetPosition = attributes.battleAI.currentEnemyChosen.transform.position + randomDirection * randomDistance;
    ...
    public Vector2 ImproveTargetPos(Vector2 targetPosition){
        ...
        if (borderObject != null)
        {
            ...
            if (targetPosition.y > borderYPosition)
            {
                ...
                targetPosition.y = borderYPosition - 10f; // Adjust as necessary
            }
