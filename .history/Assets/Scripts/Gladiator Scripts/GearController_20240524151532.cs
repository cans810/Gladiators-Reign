...
public class GearController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (shoesSpot_right != null)
        {
            if (ShoesWorn == null)
            {
                UnequipGear(shoesSpot_right);
                UnequipGear(shoesSpot_left);
            }
            else
            {
                GameObject shoes_Right = GameObject.Instantiate(ShoesWorn);
                shoes_Right.transform.SetParent(shinGuardSpot_right.transform);
                ...
                shoes_Left.transform.SetParent(shinGuardSpot_left.transform);
