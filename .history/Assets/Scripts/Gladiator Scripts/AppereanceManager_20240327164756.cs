...
public class AppereanceManager : MonoBehaviour
{
    ...
    public void detectCurrentRace(){
        if (racesDict[currentRace].Equals("Human")){
            ...
            currentRegionsDict = GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().humanRegionsDict;
        }
        else if (racesDict[currentRace].Equals("Elf")){

            currentRegionsDict = GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().elfRegionsDict;
        }
    }
