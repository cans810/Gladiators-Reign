...
public class GLAttributes : MonoBehaviour
{
    ...
    public int Strength; // increases melee power
    ...
    public int Vitality; // increases HP
    public int Wisdom; // Affects mana points and spell effectiveness, particularly for support and healing spells.
    public int Endurance; // Influences health points and stamina capacity.   
