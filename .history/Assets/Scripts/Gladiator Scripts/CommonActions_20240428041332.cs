...
public class CommonActions : MonoBehaviour
{
    ...
    IEnumerator WalkToPointMeleeAttackCoroutine()
    {
        ...
        while (!hasArrivedToAttack(attributes.battleAI.targetWalkPos) && attributes.battleAI.currentActionKey == "WalkToPointMeleeAttack")
        {
        ...
        if (attributes.battleAI.currentActionKey != "WalkToPointMeleeAttack"){
            StopAttackMelee();
        }
        else{
            AttackMelee();
    ...
    IEnumerator KeepDistanceCoroutine()
    {
        ...
        while (!hasArrivedToWalkDest(targetPosition) && attributes.battleAI.currentActionKey == "KeepDistance")
        {
    ...
    IEnumerator TakeGuardCoroutine()
    {
        ...
        if (attributes.battleAI.currentActionKey == "TakeGuard"){
    ...
    public Vector2 ImproveTargetPos(Vector2 targetPosition)
    {
        ...
        if (borderUpperObject != null)
        {
            ...
            {
                targetPosition.y = borderYPosition - 1f;
        ...
        if (borderLowerObject != null)
        {
            float borderYPosition = borderLowerObject.transform.position.y;
        ...
        if (borderLeftObject != null)
        {
            float borderXPosition = borderLeftObject.transform.position.x;

            if (targetPosition.x <= borderXPosition + 0.4f)
            {
                targetPosition.x = borderXPosition + 1f;
        ...
        if (borderRightObject != null)
        {
            float borderXPosition = borderRightObject.transform.position.x;
