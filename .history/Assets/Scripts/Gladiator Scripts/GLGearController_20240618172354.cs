...
public class GLGearController : MonoBehaviour
{
    ...
    public void Update(){
        if (inventory.HelmetWorn != null && !isSpotFull(helmetSpot)){
            ...
            inventory.HelmetWorn.GetComponent<SpriteRenderer>().sortingLayerName = glSPR.sortingLayerName;
            inventory.HelmetWorn.GetComponent<SpriteRenderer>().sortingOrder = glSPR.sortingOrder + 1;
        }
        if (inventory.ChestplateWorn != null && !isSpotFull(chestplateSpot)){
            ...
            inventory.ChestplateWorn.GetComponent<SpriteRenderer>().sortingLayerName = glSPR.sortingLayerName;
            inventory.ChestplateWorn.GetComponent<SpriteRenderer>().sortingOrder = glSPR.sortingOrder + 1;
        }
        if (inventory.ShoulderguardWorn != null && !isSpotFull(shoulderguardSpot_right)){
            ...
            inventory.ShoulderguardWorn.GetComponent<SpriteRenderer>().sortingLayerName = glSPR.sortingLayerName;
            inventory.ShoulderguardWorn.GetComponent<SpriteRenderer>().sortingOrder = glSPR.sortingOrder + 1;

            GameObject gl_left_arm = GameObject.Find("right_arm");
            SpriteRenderer glSPR_L = gl_right_arm.GetComponent<SpriteRenderer>();
