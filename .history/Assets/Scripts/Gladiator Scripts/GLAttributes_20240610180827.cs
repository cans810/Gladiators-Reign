    ...
    void Update()
    {
        if (SceneManager.GetActiveScene().name.Equals("BattleScene")){
            if (HP <= 0){
                ...
                gladiatorManager.gladiatorState.dying = false;
            }
        }
        ...
        if (gladiatorManager.battleAI.currentActionKey != "GetKilled" && gladiatorManager.gladiatorState.dying && gladiatorManager.gladiatorState.alive){
