...
public class CommonActions : MonoBehaviour
{
    ...
    IEnumerator KeepDistanceCoroutine(Transform enemyTransform, float distance)
{
    animator.SetBool("Walk", true);
    ...
    // Calculate the target position that maintains the desired distance from the enemy
