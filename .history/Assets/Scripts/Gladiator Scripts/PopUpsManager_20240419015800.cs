...
public class PopUpsManager : MonoBehaviour
{
    ...
    {
        GameObject popup = Instantiate(hitPopUpTextPrefab, new Vector3(opponent.transform.position.x + 10, transform.position.y, transform.position.z), Quaternion.identity);
