...
public class CommonActions : MonoBehaviour
{
    ...
    public void DamageMelee(){
        if (attrigladiatorManagerbutes.HitBox.objectsInHitbox.Contains(gladiatorManager.battleAI.currentEnemyChosen)){
            ...
            && (!gladiatorManager.battleAI.currentEnemyChosen.GetComponent<Attributes>().dying && attributes.battleAI.currentEnemyChosen.GetComponent<Attributes>().alive)){
                int hpBefore = (int)gladiatorManager.battleAI.currentEnemyChosen.GetComponent<Attributes>().gladiatorManager;
                ...
                gladiatorManager.battleAI.currentEnemyChosen.GetComponent<Attributes>().PopupsManager.GetComponent<PopUpsManager>().HitPopUp(attributes.battleAI.currentEnemyChosen.GetComponent<Attributes>().amount_GotHit
