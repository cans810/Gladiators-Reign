...
public class PopUpsManager : MonoBehaviour
{
    ...
    {
        float randomDistanceX = Random.Range(-10,10);
        float randomDistanceY = Random.Range(-10,10);

        GameObject popup = Instantiate(hitPopUpTextPrefab, new Vector3(opponent.transform.position.x + randomDistanceX, opponent.transform.position.y, opponent.transform.position.z), Quaternion.identity);
