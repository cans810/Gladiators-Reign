...
public class GLGearController : MonoBehaviour
{
    ...
    public void WearChestplate(GameObject chestplateToWear){
        ...
        chestplateToWear.transform.localPosition = inventory.RightHandWorn.transform.localPosition; // Optional: reset position
    ...
    public void WearWristguard(GameObject wristGuardRightToWear, GameObject wristGuardLeftToWear){
        ...
        wristGuardRightToWear.transform.localPosition = Vector3.zero;
        wristGuardRightToWear.transform.localRotation = Quaternion.identity;
        wristGuardRightToWear.transform.localScale = Vector3.one;

        wristGuardLeftToWear.transform.SetParent(wristGuardSpot_left.transform);
        wristGuardLeftToWear.transform.localPosition = Vector3.zero;
        wristGuardLeftToWear.transform.localRotation = Quaternion.identity;
        wristGuardLeftToWear.transform.localScale = Vector3.one;
    }
