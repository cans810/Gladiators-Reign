...
public class CommonActions : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        attributes.rb.MoveRotation(attributes.rb.rotation + revSpeed * Time.fixedDeltaTime);
    }
    ...
    public void FaceTowardsEnemy(Vector2 enemyPos)
    {
        ...
        {
            attributes.rb.rotation = 180f; // Face left
        }
        else // Enemy is on the right
        {
            attributes.rb.rotation = 0f; // Face right
        }
    }
