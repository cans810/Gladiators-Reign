    ...
    void Start()
    {
        if (GetComponent<Attributes>().race.Equals("Human")){
            if (GetComponent<Attributes>().raceRegion.Equals("Eldorian")){
                ...
                nose.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanMouth_Eldorian","eyeNormal");
                mouth.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanEyes_Eldorian","eyeNormal");
            }
