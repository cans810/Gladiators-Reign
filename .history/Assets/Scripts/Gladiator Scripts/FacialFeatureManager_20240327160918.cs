    ...
    void Start()
    {
        if (GetComponent<Attributes>().race.Equals("Human")){
            if (GetComponent<Attributes>().raceRegion.Equals("Eldorian")){
                GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanEyes_Eldorian","eyeNormal");
            }
            if (GetComponent<Attributes>().raceRegion.Equals("Mistvalian")){
                GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanEyes_Mistvalian","eyeNormal");
            }
            if (GetComponent<Attributes>().raceRegion.Equals("Avalorian")){
                GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanEyes_Avalorian","eyeNormal");
            }
        }
