...
public class DetachEntityParts : MonoBehaviour
{
    ...
    public void detachHead()
    {
        ...
        if (foundHead != null && foundHeadBone != null)
        {
            ...
            GameObject detachedHeadBone = GameObject.Instantiate(foundHeadBone.gameObject,detachedHeadObject.tr);
            ...
            // detachedHead.transform.position = detachedHeadPrefabPos.position;
            // detachedHeadBone.transform.position = detachedHeadPrefabPos.position;

            detachedHead.transform.localPosition = detachedHeadPrefabPos.position;
            detachedHeadBone.transform.localPosition = detachedHeadPrefabPos.position;
