...
public class DetachEntityParts : MonoBehaviour
{
    public void detachHead()
    {
        ...
        if (foundHead != null && foundHeadBone != null)
        {
            ...
            detachedHeadBone.transform.localPosition = new Vector3(detachedHead.transform.localPosition.x, detachedHead.transform.localPosition.y*5, detachedHead.transform.position.z);
