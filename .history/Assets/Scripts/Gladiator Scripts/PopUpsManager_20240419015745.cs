...
public class PopUpsManager : MonoBehaviour
{
    ...
    IEnumerator HitPopUpCoroutine(int amount_GotHit, GameObject oppo)
    {
        GameObject popup = Instantiate(hitPopUpTextPrefab, new Vector3(transform.position.x + 10, transform.position.y, transform.position.z), Quaternion.identity);
