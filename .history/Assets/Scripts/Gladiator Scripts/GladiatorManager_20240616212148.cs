...
public class GladiatorManager : MonoBehaviour
{
    ...
    public void create_GLInfoTab()
    {
        ...
        GLInfoTab.transform.localScale = new Vector3(4f, 4f, 4f);
    }
    ...
    public void create_GLActionsTab()
    {
        ...
        GLActionsTab.GetComponent<GLInfoTabManager>().GLBelongTo = gameObject;
        GLActionsTab.transform.SetParent(canvas.transform);

        // Reset the transform components
        GLActionsTab.GetComponent<GLInfoTabManager>().setPosition();
