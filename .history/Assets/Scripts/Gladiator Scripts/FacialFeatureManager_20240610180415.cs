...
public class FacialFeatureManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (GetComponent<GLAttributes>().race.Equals("Human")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Elf")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Eastern Human")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Orc")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Troll")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Demon")){
        ...
        else if (GetComponent<GLAttributes>().race.Equals("Wraith")){
            eyes.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("WraithEyes","eyeNormal");
            nose.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("WraithNose","nose");
            mouth.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("WraithMouth","mouthNormal");
        }
