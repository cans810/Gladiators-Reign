...
public class GLClassDescriptions{
    public static string GetDescription(GladiatorClass gladiatorClass)
    {
        switch (gladiatorClass)
        {
            case GladiatorClass.Bloodreaver:
                return "A fierce warrior who thrives in the heat of battle, dealing devastating damage.";
            case GladiatorClass.Mystic:
                return "A master of arcane arts, using powerful spells to alter the course of battle.";
