...
public class GLBattleAI : MonoBehaviour
{
    ...
    {
        isPaused = true;
        // Optionally, you can add any additional pause logic here
    }

    public void ResumeAI()
    {
        isPaused = false;
        // Optionally, you can add any additional resume logic here
    }

    void Update()
    {
        if (GetComponent<GLState>().alive && startAI && !GetComponent<GLState>().dying && !isPaused)
        {
