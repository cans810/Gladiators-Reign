...
public class BattleAI : MonoBehaviour
{
    ...
    void Update()
    {
        if (attributes.alive && startAI && !attributes.dying)
        {
    ...
    public void ExecuteNext()
    {
        ...
        if (actionQueue.queue.Count > 0)
        {
            ...
            if (currentAction != null)
            {
                ...
                Debug.Log(prioritizedAction.methodName);
                ...
                if (prioritizedAction != null)
                {
                    ...
                    Debug.Log("prioritized action found");  
                }
                    ...
                    Debug.Log("prioritized action not found");  
                }
            }
        }
    }
