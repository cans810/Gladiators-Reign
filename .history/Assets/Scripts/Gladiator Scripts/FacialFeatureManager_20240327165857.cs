...
public class FacialFeatureManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (GetComponent<Attributes>().race.Equals("Human")){
            if (GetComponent<Attributes>().raceRegion.Equals("Eldorian")){
            ...
            else if (GetComponent<Attributes>().raceRegion.Equals("Mistvalian")){
            ...
            else if (GetComponent<Attributes>().raceRegion.Equals("Avalorian")){
                ...
                mouth.GetComponent<SpriteRenderer>().sprite = textures.GetSprite("HumanMouth_Avalorian","mouthNormal");
            }
        }
