...
public class GLAttributes : MonoBehaviour
{
    ...
    public void resetGladiator(){
        ...
        GetComponent<AnimationsManager>().StopAction("GetKilled_1");
        GetComponent<AnimationsManager>().StopAction("GetKilled_2");
        GetComponent<AnimationsManager>().StopAction("GetKilled_3");
    }
}
