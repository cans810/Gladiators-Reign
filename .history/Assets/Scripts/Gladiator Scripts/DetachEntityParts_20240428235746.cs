...
public class DetachEntityParts : MonoBehaviour
{
    public void detachHead()
    {
        ...
        if (foundHead != null && foundHeadBone != null)
        {
            ...
            detachedHeadBone.transform.position = new Vector3(detachedHead.transform.position.x, detachedHead.transform.position.y*5, detachedHead.transform.position.z);
