...
public class GLAttributes : MonoBehaviour
{
    ...
    public void InitGladiator(int Vitalis, int Vigor, int Resolve, int Aetherius, int Celerity, int Ferocity, int Insight, int Fortitude, int Harmony, int ArcaneMastery, int ){
