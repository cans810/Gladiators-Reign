...
public class PlayerActionsCanvasController : MonoBehaviour
{
    ...
    void Update()
    {
        transform.position = new Vector3(Player.Instance.gameObject.transform.position.x,Player.Instance.gameObject.transform.position.y,Player.Instance.gameObject.transform.position.z)
    }
