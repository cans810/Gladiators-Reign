...
public class DetachEntityParts : MonoBehaviour
{
    public void detachHead()
    {
        ...
        if (foundHead != null && foundHeadBone != null)
        {
            ...
            detachedHead.transform.localPosition = new Vector3(0,0,0);
            detachedHeadBone.transform.localPosition = new Vector3(0,0,0);

            detachedHead.transform.localRotation = Quaternion.Euler(0,0,0);
            detachedHeadBone.transform.localRotation = Quaternion.Euler(0,0,0);

            // detachedHeadBone.transform.position = detachedHead.transform.position;
            // detachedHeadBone.transform.rotation = detachedHead.transform.rotation;
