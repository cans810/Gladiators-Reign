...
public class GLGearController : MonoBehaviour
{
    ...
    public void WearShoulderguard(GameObject shoulderGuardRightToWear, GameObject shoulderGuardLeftToWear){
        ...
        shoulderGuardRightToWear.transform.localPosition = inventory.ShoulderguardWorn.transform.localPosition; // Optional: reset position
        shoulderGuardRightToWear.transform.localRotation = inventory.ShoulderguardWorn.transform.localRotation; // Optional: reset rotation
        shoulderGuardRightToWear.transform.localScale = inventory.ShoulderguardWorn.transform.localScale; // Optional: reset scale

        shoulderGuardLeftToWear.transform.SetParent(shoulderguardSpot_left.transform);
        shoulderGuardLeftToWear.transform.localPosition = inventory.ShoulderguardWorn.transform.position; // Optional: reset position
        shoulderGuardLeftToWear.transform.localRotation = inventory.ShoulderguardWorn.transform.localRotation; // Optional: reset rotation
        shoulderGuardLeftToWear.transform.localScale = inventory.ShoulderguardWorn.transform.localScale; // Optional: reset scale
    }
