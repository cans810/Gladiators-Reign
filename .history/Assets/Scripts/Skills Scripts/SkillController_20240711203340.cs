...
public class SkillController : MonoBehaviour
{
    ...
    LevelUpSceneManager levelupManager;
    ...
    void Start()
    {
        ...
        levelupManager = GameObject.Find("LevelupSceneManager").GetComponent<LevelUpSceneManager>();
    }
    ...
    public void selectSkill(){
        LevelUpSceneManager levelupManager = GameObject.Find("LevelupSceneManager").GetComponent<LevelUpSceneManager>();
    ...
    public void onMouseHover(){
        ...
        generatedPopupInfo.transform.position = skillTreeCanvas.transform.Find("PopUpPos").gameObject.transform.position;
    }
