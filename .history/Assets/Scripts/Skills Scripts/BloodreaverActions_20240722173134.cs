...
public class BloodreaverActions : MonoBehaviour
{
    ...
    IEnumerator WalkTo_RavagingFuryAttack_Coroutine()
    {
        ...
        GetComponent<Rigidbody2D>().velocity = direction * GetComponent<GLAttributes>().WalkSpeed * 0.9f;
        ...
        GetComponent<Rigidbody2D>().velocity = direction2 * GetComponent<GLAttributes>().WalkSpeed * 0.9f;
