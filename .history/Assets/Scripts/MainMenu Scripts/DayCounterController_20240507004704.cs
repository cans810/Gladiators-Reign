...
public class DayCounterController : MonoBehaviour
{
    ...
    void Update()
    {
        if (SceneManager.GetActiveScene().name == "MainMenuScene" || SceneManager.GetActiveScene().name == "BattleScene" || SceneManager.GetActiveScene().name == "GladiatorCreationScene"){
