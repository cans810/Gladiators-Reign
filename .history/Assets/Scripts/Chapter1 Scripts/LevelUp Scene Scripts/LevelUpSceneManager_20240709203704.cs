...
public class LevelUpSceneManager : MonoBehaviour
{
    ...
    public void setButtons(){
        if (classTMP.text.Equals("Blademaster")){

        }
        if (classTMP.text.Equals("Shieldbearer")){
            
        }
        if (classTMP.text.Equals("Mystic")){
            
        }
        if (classTMP.text.Equals("Elementalist")){
            
        }
        if (classTMP.text.Equals("Assassin")){
            
        }
        if (classTMP.text.Equals("Beastmaster")){
            
        }
        if (classTMP.text.Equals("WarMage")){
            
        }
        if (classTMP.text.Equals("Berserker")){
