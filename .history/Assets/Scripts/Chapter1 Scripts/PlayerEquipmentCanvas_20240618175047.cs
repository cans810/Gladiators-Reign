...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    public void equipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("ShoulderGuard")){
            itemGenerated = Instantiate(AllItemsContainer.Instance.GetShoulderguard(currentSelectedItem.GetComponent<UI_Item>().itemName),GetComponent<GLGearController>().s.transform);
