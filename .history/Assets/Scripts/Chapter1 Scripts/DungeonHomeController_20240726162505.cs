...
public class DungeonHomeController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (sceneMode != null && sceneMode.Equals("MultiFight"))
        {
            NPCMultifightArrangerController.randomFighterAmount();
        }
    }
    ...
    void Update()
    {
        ...
        if (sceneMode != null && sceneMode.Equals("MultiFight"))
        {
            if (NPCMultifightArrangerController.gladiatorAmount == GameManager.Instance.gladiatorsSelectedForFight.Count)
            {
    ...
    public void OnClickSelectFighter(GameObject gladiator)
    {
        ...
        GameManager.Instance.gladiatorsSelectedForFight.Add(gladiator);
    }

    public void GoToBeforeBattleScene()
    {
