...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    public void equipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Chestplate")){
            itemGenerated = Instantiate(AllItemsContainer.Instance.GetChestplate(currentSelectedItem.GetComponent<UI_Item>().itemName), GetComponent<GLGearController>().helmetSpot.transform);
