...
public class DungeonHomeController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < GameManager.Instance.playerGLs.Count; i++)
        {
            ...
            GameManager.Instance.playerGLs[i].GetComponent<ClickableObject>().onClick.AddListener(() => OnGladiatorClickActions(generatedGladiator));
        }
    }
    ...
    public void OnGladiatorClickActions(){
