...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    public void unEquipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("ShoulderGuard")){
            GetComponent<GLGearController>().UnequipGear(GetComponent<GLGearController>().shoulderguardSpot_right, Player.Instance.GetComponent<GLGearController>().shoulderguardSpot_left);
        }
    }
