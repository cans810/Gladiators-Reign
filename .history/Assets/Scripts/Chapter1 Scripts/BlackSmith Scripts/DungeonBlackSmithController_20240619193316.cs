...
public class DungeonBlackSmithController : MonoBehaviour
{
    ...
    public void buySelectedItem(){
        GameObject boughtItemGenerated = Instantiate(AllItemsContainer.Instance.GetAnyArmor(currentSelectedItem.GetComponent<UI_Item>().itemName));

        GameManager.Instance.playerInventory.Add(boughtItemGenerated);
    }
