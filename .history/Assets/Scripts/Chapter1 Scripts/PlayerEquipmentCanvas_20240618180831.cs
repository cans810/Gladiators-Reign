...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    public void equipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Pant")){
            itemGenerated = Instantiate(AllItemsContainer.Instance.GetPant(currentSelectedItem.GetComponent<UI_Item>().itemName));
            itemGeneratedPair = Instantiate(AllItemsContainer.Instance.GetPant(currentSelectedItem.GetComponent<UI_Item>().itemName));

            GetComponent<GLGearController>().WearWristguard(itemGenerated);
        }
    }
