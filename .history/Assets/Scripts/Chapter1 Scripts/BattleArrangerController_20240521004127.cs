...
public class BattleArrangerController : MonoBehaviour
{
    ...
    {
        Player.Instance.GetComponent<CommonActions>().WalkToPoint(BattleArranger.transform.Find("playerPos").transform.position,1.7f);
    ...
    {
        Player.Instance.GetComponent<CommonActions>().WalkToPoint(GameObject.Find("DungeonControllerCanvas").transform.Find("playerPos").transform.position,1.7f);
        
        Camera.main.GetComponent<Animator>().SetBool("ZoomOnBattleArranger", false);
        Camera.main.GetComponent<Animator>().SetBool("ZoomOutFromBattleArranger", true);
    ...
    IEnumerator BattleArrangerClosedCoroutine(){
        ...
        Camera.main.GetComponent<Animator>().SetBool("ZoomOutFromBattleArranger", false);
        BattleArrangerCloseButton.SetActive(false);
    }
}
