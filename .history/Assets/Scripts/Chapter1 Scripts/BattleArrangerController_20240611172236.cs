...
public class BattleArrangerController : MonoBehaviour
{
    ...
    {
        //Player.Instance.GetComponent<GLCommonActions>().WalkToPoint(BattleArranger.transform.Find("playerPos").transform.position,2f);
    ...
    {
        //Player.Instance.GetComponent<GLCommonActions>().WalkToPoint(GameObject.Find("DungeonControllerCanvas").transform.Find("playerPos").transform.position,2f);
