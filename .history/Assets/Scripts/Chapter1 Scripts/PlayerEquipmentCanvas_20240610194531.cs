...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    void Start()
    {
        foreach (ArmorData armor in Player.Instance.GetComponent<GLInventory>().items){
    ...
    public void equipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Helmet")){
            ...
            Player.Instance.GetComponent<GLGearController>().WearHelmet(itemGenerated);
        }
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Chestplate")){
            ...
            Player.Instance.GetComponent<GLGearController>().WearChestplate(itemGenerated);
        }
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("ShoulderGuard")){
            ...
            Player.Instance.GetComponent<GLGearController>().WearShoulderguard(itemGenerated , itemGeneratedPair);
        }
    }

    public void unEquipSelectedItem(){
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Helmet")){
            Player.Instance.GetComponent<GLGearController>().UnequipGear(Player.Instance.GetComponent<GLGearController>().helmetSpot, null);
        }

        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("Chestplate")){
            Player.Instance.GetComponent<GLGearController>().UnequipGear(Player.Instance.GetComponent<GLGearController>().chestplateSpot, null);
        }

        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("ShoulderGuard")){
            Player.Instance.GetComponent<GLGearController>().UnequipGear(Player.Instance.GetComponent<GLGearController>().shoulderguardSpot_right, Player.Instance.GetComponent<GLGearController>().shoulderguardSpot_left);
        }
    }
