...
public class BlackSmithController : MonoBehaviour
{
    ...
    public void Dungeons_BlackSmithInteraction()
    {
        ...
        Player.Instance.GetComponent<CommonActions>().WalkToPoint(gameObject.transform.Find("playerPos").transform.position,2.3f);
    }
    ...
    public void Dungeons_BattleArrangerClosed()
    {
        ...
        Player.Instance.GetComponent<CommonActions>().WalkToPoint(GameObject.Find("DungeonControllerCanvas").transform.Find("playerPos").transform.position,2.3f);
