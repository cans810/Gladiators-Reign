...
public class PlayerEquipmentCanvas : MonoBehaviour
{
    ...
    public void equipSelectedItem(){
        ...
        if (currentSelectedItem.GetComponent<UI_Item>().itemName.Contains("ShoulderGuard")){
            ...
            itemGeneratedPair = Instantiate(AllItemsContainer.Instance.GetShoulderguard(currentSelectedItem.GetComponent<UI_Item>().itemName),GetComponent<GLGearController>().shoulderguardSpot_left.transform);
