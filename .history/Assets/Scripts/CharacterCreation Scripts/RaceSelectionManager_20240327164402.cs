...
public class RaceSelectionManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerGladiator.GetComponent<Attributes>().raceRegion = playerGladiator.GetComponent<AppereanceManager>().currentRegionsDict[playerGladiator.GetComponent<AppereanceManager>().currentRegionNum];
