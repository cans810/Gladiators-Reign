...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public void detectCurrentRace(){
        if (GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.racesDict[GetComponent<RaceSelectionManager>().currentRace].Equals("Human")){
