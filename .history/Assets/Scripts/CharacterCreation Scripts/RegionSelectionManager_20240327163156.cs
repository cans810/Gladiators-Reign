...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public void detectCurrentRace(){
        if (GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.racesDict[GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.currentRace].Equals("Human")){
            currentRegionsDict = humanRegionsDict;
        }
        else if (GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.racesDict[GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.currentRace].Equals("Elf")){
