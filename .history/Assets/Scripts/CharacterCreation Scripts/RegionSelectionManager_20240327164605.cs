...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public void nextRegion(){
        if (GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().currentRegion < 3-1){
            ...
            GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<Attributes>().raceRegion = GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().currentRegionsDict[currentRegionNum];
        }
    }
    ...
    public void detectCurrentRace(){
        ...
        racesDict[GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.currentRace].Equals("Elf")){
            ...
            GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().currentRegionsDict = elfRegionsDict;
        }
    }
}
