...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public Dictionary<string,string> regionsDict;
    ...
    public void Start(){
        ...
        regionsDict.Add("Human","Eldorian");
        regionsDict.Add("Human","Elf");
        regionsDict.Add("Human","Eastern Human");
        regionsDict.Add(3,"Orc");
        regionsDict.Add(4,"Troll");
        regionsDict.Add(5,"Demon");
        regionsDict.Add(6,"Wraith");
