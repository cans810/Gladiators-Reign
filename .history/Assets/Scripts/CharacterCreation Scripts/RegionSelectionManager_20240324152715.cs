...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public void changeLooks(){
        ...
        if (humanRegion_1Look[1] != null){
            eye_brows.sprite = humanRegion_1Look[1];
        }
        if (humanRegion_1Look[2] != null){
            eye_brows.sprite = humanRegion_1Look[2];
        }
        if (humanRegion_1Look[3] != null){
            eye_brows.sprite = humanRegion_1Look[3];
        }
        // accessories
        if (humanRegion_1Look[4] != null){
            eye_brows.sprite = humanRegion_1Look[4];
        }
        if (humanRegion_1Look[5] != null){
            eye_brows.sprite = humanRegion_1Look[5];
        }
    }
}
