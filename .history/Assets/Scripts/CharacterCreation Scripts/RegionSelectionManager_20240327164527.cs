...
public class RegionSelectionManager : MonoBehaviour
{
    ...
    public void nextRegion(){
        if (GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().currentRegion < 3-1){
            ...
            currentRegionText.text = GetComponent<RaceSelectionManager>().playerGladiator.currentRegionsDict[GetComponent<RaceSelectionManager>().playerGladiator.GetComponent<AppereanceManager>().currentRegion];
    ...
    public void detectCurrentRace(){
        ...
        racesDict[GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.currentRace].Equals("Human")){
            ...
            GetComponent<RaceSelectionManager>().playerGladiator.currentRegionsDict = GetComponent<RaceSelectionManager>().playerGladiator.humanRegionsDict;
        }
        ...
        racesDict[GetComponent<RaceSelectionManager>().GetComponent<RaceSelectionManager>().appereanceManager.currentRace].Equals("Elf")){
            ...
            GetComponent<RaceSelectionManager>().playerGladiator.currentRegionsDict = GetComponent<RaceSelectionManager>().playerGladiator.elfRegionsDict;
        }
    }
}
