...
public class RaceSelectionManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GetComponent<RegionSelectionManager>().changeLooks();
        GetComponent<RegionSelectionManager>().currentRegionText.text = GetComponent<RegionSelectionManager>().regionsDict[GetComponent<RegionSelectionManager>().currentRegionNum];
    }
