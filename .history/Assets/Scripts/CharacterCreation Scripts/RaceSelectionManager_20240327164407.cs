...
public class RaceSelectionManager : MonoBehaviour
{
    ...
    public void nextRace(){
        if (appereanceManager.currentRace < appereanceManager.racesSpriteLibraries.Count-1){
            ...
            playerGladiator.GetComponent<Attributes>().raceRegion = playerGladiator.GetComponent<AppereanceManager>().currentRegionsDict[GetComponent<RegionSelectionManager>().currentRegion];
