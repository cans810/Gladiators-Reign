...
public class AllItemsContainer : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        allArmors.AddRange(Instance.allLegGuards);
        allArmors.AddRange(Instance.allShinGuards);
        allArmors.AddRange(Instance.allShoes);
    }

    public GameObject GetAnyArmor(string itemName)
    {
        foreach (GameObject item in allArmors){
