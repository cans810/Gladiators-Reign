...
public class UIRewardGladiator : MonoBehaviour
{
    ...
    public void SetRewarededGladiator(GameObject gladiator_rewarded){
        this.gladiator_rewarded = gladiator_rewarded;

        gladiatorHeadImage.sprite = gladiator_rewarded.transform.Find("head").GetComponent<SpriteRenderer>().sprite;
